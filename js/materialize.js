jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
            ...
            setPropertyValue: function (a, c, d, e, f) {
                ...
                if ("scroll" === c)
                    ...
                    if (v.Normalizations.registered[c] && (d = v.Normalizations.registered[c]("inject", a, d),
                            c = v.Normalizations.registered[c]("name", a)), h = v.Names.prefixCheck(c)[0], 8 >= n)
                        try {
                            a.style[h] = d;
                        } catch (k) {
            ...
            function e() {
                function a(a) {
                    ...
                    function r() {
                        ...
                        var h = 100, i = {};
                        if (e && d)
                            i.emToPx = I.lastEmToPx, i.percentToPxWidth = I.lastPercentToPxWidth,
    ...
    function R(a, b) {
        ...
        for (e = 0; e < g.length; )
            d[g[e].identifier] && h.push(g[e]), b & (Aa | Ba) && delete d[g[e].identifier],
                    e++;
        ...
        recognize: function (a) {
            ...
            if (!b.stopped) {
                ...
                for (var f = 0; f < d.length; )
                    c = d[f], b.stopped === mb || e && c != e && !c.canRecognizeWith(e) ? c.reset() : c.recognize(a),
        ...
        a(this).each(function () {
            ...
            if (!d.hasClass("browser-default")) {
                ...
                if (f && (d.parent().find("span.caret").remove(), d.parent().find("input").remove(),
                        d.unwrap(), a("ul#select-options-" + f).remove()), "destroy" === b)
        ...
        var s = !1, t = {
            ...
            set: function (b, c, d) {
                ...
                if (d = g && a.isPlainObject(c) ? c : d || {}, b) {
                    g || (h[b] = c);
                    for (e in h)
                        f = h[e], e in y.component.item && (void 0 === f && (f = null), y.component.set(e, f, d)),
    ...
    c.prototype.set = function (a, b, c) {
        ...
        if (i || j) {
            for (j ? (f = c.year, g = c.month, h = c.date) : (f = + c[0], g = + c[1], h = + c[2]),
                    ...
                    f = e.getFullYear(), g = e.getMonth(); new Date(f, g, h).getMonth() !== g; )
                h -= 1;
            c = [f, g, h];
        }
        return c;
