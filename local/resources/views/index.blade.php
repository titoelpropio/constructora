                                ...
                                <div class="card-content">
                                    ...
                                    <div class="col s12 m12 l6">
                                        <div class="trending-bar-chart-wrapper">
                                            <span class="chart-title black-text"><strong>VENTAS POR USUARIO</strong></span>
                        ...
                        <div class="card-move-up waves-effect waves-block waves-light">
                            <div class="move-up cyan darken-1" >
                                <div>
                                    ...
                                    <div class="switch chart-revenue-switch right">
                                        <label class="blue-text text-lighten-5">
                                            IMPORTE
                                            <input type="checkbox" id="checkImporte" value="false" checked
                                                   onclick="checkdash(this)"name='cht'>
                                            <span class="lever"></span> CANTIDAD
                                        </label>


                                    </div>
                                    <div class="trending-line-chart-wrapper" id='limpiar'>
                            ...
                            <div class="card-content white">
                                ...
                                <div class="col s12 m12">
                                    <div class="trending-bar-chart-wrapper" id='charventauser'>
                                        <span class="chart-title black-text"><strong>VENTAS POR USUARIO</strong></span>
                                        <canvas id="trending-bar-chart" height="90"></canvas>                                                
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-move-up waves-effect waves-block waves-light">
                                <div class="move-up orange accent-3">
                                    ...
                                    <div class="trending-line-chart-wrapper">
                                        <span class="chart-title white-text"><strong>VENTAS MENSUALES</strong></span>
                                        <canvas id="trending-line-chart2" height="70"></canvas>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-reveal">
                                <span class="card-title grey-text text-darken-4"><strong>VENTAS MENSUALES</strong><i class="mdi-navigation-close right"></i></span>
                                <table class="responsive-table">
                                    <thead>
                                        <tr>
                                            <th data-field="country-name">MES</th>
                    ...
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-move-up waves-effect waves-block waves-light">
                                <div class="move-up red accent-2">
                                    <div>
                                        <span class="chart-title white-text"><strong>TOP: PRODUCTOS MAS VENDIDOS</strong></span>
                                    </div>
                                    <div class="trending-line-chart-wrapper">
                                        <canvas id="line-chart2" height="90"></canvas>
                                    </div>
