...
<div id="modal1" class="modal modal-fixed-footer">
    <div class="modal-content">
        ...
        <h4><strong>Agregar herramienta Obra</strong></h4>
                ...
                {!!Form::label('herramienta','herramienta: ')!!}
                 <select name="herramienta" id="herramienta">
                    ...
                    for ($i=0; $i < count($herramienta); $i++) { 
                       echo "<option value='".$herramienta[$i]->id."'>".$herramienta[$i]->nombre;
                    }
                    ?>
                </select>
            </div>
...
<div id="modal2" class="modal modal-fixed-footer">
    <div class="modal-content">
        ...
        <h4><strong>Actualizar herramienta</strong></h4>
        <div class="divider"></div>
         <div class="row">
            <div class=" col s12 m12 l12">
                <i class="mdi-action-account-circle prefix"></i>
            ...
            <div class="col s12 m12 l12">
                <i class="mdi-action-label-outline prefix"></i>
                {!!Form::label('herramienta','herramienta: ')!!}
                 <select name="herramienta" id="herramientas">
                    <?php 
                    for ($i=0; $i < count($herramienta); $i++) { 
                       echo "<option value='".$herramienta[$i]->id."'>".$herramienta[$i]->nombre;
                    }
